<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="@if(Route::is("admin.index")) active @endif"><a class="nav-link" href="{{ route('admin.index') }}"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>

            <li class="@if(Route::is("admin.setting.edit")) active @endif"><a class="nav-link" href="{{ route("admin.setting.edit") }}"><i class="fa fa-cog"></i> <span>Setting</span></a></li>
    ...
    <li class="@if(Route::is("admin.datewise-room")) active @endif"><a class="nav-link" href="{{ route("admin.datewise-room") }}"><i class="fa fa-calendar"></i> <span>Room Datewise</span></a></li>
        ...
        <li class="@if(Route::is("admin.page.customer.edit")) active @endif"><a class="nav-link" href="{{ route("admin.page.customer.edit") }}"><i class="fa fa-angle-right"></i> Customer Pages</a></li>
            ...
            <li class="@if(Route::is("admin.subscribers")) active @endif"><a class="nav-link" href="{{ route("admin.subscribers") }}"><i class="fa fa-users"></i> Subscribers</a></li>
            
            <li class="@if(Route::is("admin.customers")) active @endif"><a class="nav-link" href="{{ route('admin.customers') }}"><i class="fa fa-user-plus"></i> <span>Customers</span></a></li>

            <li class="@if(Route::is("admin.orders")) active @endif"><a class="nav-link" href="{{ route("admin.orders") }}"><i class="fa fa-cart-plus"></i> <span>Orders</span></a></li>

            <li class="nav-item dropdown @if(Request::is("admin/slides") || Request::is("admin/slide/add")) active @endif">
                <a href="#" class="nav-link has-dropdown"><i class="fa fa-cubes"></i><span>Slides</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="nav-item dropdown @if(Request::is("admin/features") || Request::is("admin/feature/add")) active @endif">
                <a href="#" class="nav-link has-dropdown"><i class="fa fa-gavel"></i><span>Features</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="nav-item dropdown @if(Route::is("admin.testimonials") || Route::is("admin.testimonial.add")) active @endif">
                <a href="#" class="nav-link has-dropdown"><i class="fa fa-briefcase"></i><span>Testimonials</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="nav-item dropdown @if(Route::is("admin.posts") || Route::is("admin.post.add")) active @endif">
                <a href="#" class="nav-link has-dropdown"><i class="fa fa-clipboard"></i><span>Posts</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="nav-item dropdown @if(Route::is("admin.photos") || Request::is("admin/photo/add") || Request::is("admin/videos") || Request::is("admin/video/add")) active @endif">
                <a href="#" class="nav-link has-dropdown"><i class="fa fa-picture-o"></i><span>Galeria</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="nav-item dropdown @if(Route::is("admin.faqs") || Request::is("admin/faq/add")) active @endif">
                <a href="#" class="nav-link has-dropdown"><i class="fa fa-bolt"></i><span>Faqs</span></a>
                <ul class="dropdown-menu">
