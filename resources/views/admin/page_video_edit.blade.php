...
@section("title",$video->video_heading)
@section("heading",$video->video_heading)
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route("admin.page.video.update") }}" method="post">
                        @csrf
                        @method("PUT")
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="toggle-container">
                                <input @if($video->video_status == 1) checked @endif  type="checkbox" data-toggle="toggle" data-on="Yes" data-off="No" data-onstyle="success" data-offstyle="danger" name="video_status" value="Yes">
                            </div>
                            @error("video_status") <p class="text-danger m-0">{{ $message }}</p> @enderror
                        </div>
