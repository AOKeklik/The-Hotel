...
@section("button")
<div class="ml-auto">
    <a href="{{ route("admin.orders") }}" class="btn btn-primary"><i class="fa fa-eye"></i> Orders</a>
</div>
@endsection
@section("content")
                        ...
                        <table class="table table-striped table-hover table-md">
                            ...
                            @foreach($order->orderDetails as $detail)
                                <tr>
                                    ...
                                    <td class="text-center">{{ number_format($detail->room->price,2,".","") }} PLN</td>
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-12 text-right">
                            <div class="invoice-detail-item">
                                ...
                                <div class="invoice-detail-value invoice-detail-value-lg">{{ number_format($order->paid_amount,2,".","") }}</div>
                            </div>
                        </div>
                    </div>
                </div>
