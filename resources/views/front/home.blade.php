...
@if($provider_setting->home_feature_status == 1)
    <div class="home-feature">
        <div class="container">
            <div class="row">
                @foreach($features as $feature)
                @if($loop->iteration > $provider_setting->home_feature_limit) @break @endif
                    <div class="col-md-3">
                        <div class="inner">
...
@if($provider_setting->home_room_status == 1)
    <div class="home-rooms">
        <div class="container">
            ...
            <div class="row">
                ...
                @if($loop->iteration > $provider_setting->home_room_limit) @break @endif
                    <div class="col-md-3">
                        <div class="inner">
                            <div class="photo">
...
@if($provider_setting->home_testimonial_status == 1)
...
@if($provider_setting->home_post_status == 1)
    <div class="blog-item">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                ...
                @if($loop->iteration > $provider_setting->home_post_limit) @break @endif
                    <div class="col-md-4">
                        <div class="inner">
                            <div class="photo">
